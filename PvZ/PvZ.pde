...
void display() { 
   if (info) {
    ...
    fill(0, 255, 0);
    rect(450, 360, 50, 50);
    text("peashooter", 430, 435);
    fill(255, 255, 0);
    rect(540, 360, 50, 50);
    text("sunflower", 527, 435);
    fill(255);
    rect(630, 360, 50, 50);
    text("wallnut", 628, 435);
    fill(75, 0, 130);
    rect(720, 360, 50, 50);
    text("chomper", 712, 435);
    fill(255);    
    text("You can place plants by pressing on a type of plant", 50, 120);
    text("on the top and then clicking somewhere on the field.", 50, 150);
    text("While you have clicked on a type of plant,", 50, 180);    
    text("the currently held type is displayed in the top right corner.", 50, 210); 
    text("There is also a reset button below", 50, 240);
    text("it to reset the currently held type.", 50, 270);  
    text("There is also a remove option where you press on the remove text at the top of the", 50, 300);
    text("screen and click on a plant. It will remove the plant from the field, much like in the game.", 50, 330);
    text("Currently, we have 4 different types of plants:", 50, 360); 
    text("peashooters, sunflowers, wallnuts, and chompers.", 50, 390);
    text("The peashooter is your normal, average plant.", 50, 420);    
    text("The sunflower is your friend.", 50, 450);
