...
class ALHeap{
    //instance vars
    private ArrayList<Projectile> _heap; //underlying container is array of Integers
    ...
    public ALHeap() 
    { 
	_heap = new ArrayList<Projectile>();
    }
     ...
     *****************************************************/
    public void add( Projectile addVal ) 
    { 
     ...
     *****************************************************/
    public Projectile removeMin() 
    {
	if ( _heap.size() == 0 ) 
	    return null;

	//store root value for return at end of fxn
	Projectile retVal = peekMin();

	//store val about to be swapped into root
	Projectile foo = _heap.get( _heap.size() - 1);
    ...
    //************ aux helper fxns ***************
    private Projectile minOf( Projectile a, Projectile b ) 
    {
	if ( a.compareTo(b) < 0 )
	    return a;
	else
...
void setup(){
	...
	pile.add(new Projectile(1,1,1));
	System.out.println(pile);
	pile.add(new Projectile(5,1,1));
	System.out.println(pile);
	pile.add(new Projectile(9,1,1));
	System.out.println(pile);
	pile.add(new Projectile(15,1,1));
	System.out.println(pile);
	pile.add(new Projectile(2,1,1));
	System.out.println(pile);
	pile.add(new Projectile(12,1,1));
	System.out.println(pile);
	pile.add(new Projectile(1,1,1));
	System.out.println(pile);
	pile.add(new Projectile(2,1,1));
	System.out.println(pile);
	pile.add(new Projectile(3,1,1));
	System.out.println(pile);
	pile.add(new Projectile(4,1,1));
	System.out.println(pile);
